...
//燃烧地址的公钥
export const black_address = 'tNULSeBaMhZnRteniCy3UZqPjTbnWKBPHX1a5d';
//运行环境（true:正式环境，false:测试环境）
export const RUN_DEV = false;
//ChainId和资产ID
export const MAIN_INFO = {chainId: 888, assetId: 1};
...
//默认浏览器地址（跳转地址）
export const explorerUrl = 'http://scan.tofchain.com/';
//默认钱包地址（跳转地址）
